...
/**
 * This small application uses a model (PriorityList) that you have implemented
 * and tested. The view, which is a JList with your PriorityList using your
 * toArray method. If you do not have all of the methods as specified in the
 * PriorityList interface, this file will have compiletime errors.
 * 
 * @author Rick Mercer
 */
